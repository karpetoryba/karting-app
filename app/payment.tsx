    ...
    try {
      ...
      if (existingPayment) {
        ...
        if (existingPayment.status === 'completed') {
          Alert.alert('Paiement effectué', 'Cette réservation a déjà été payée');
        }
      }
    } catch (error: any) {
        ...
        <>
          ...
          <View style={styles.paymentMethods}>
            <TouchableOpacity
              ...
              disabled={processing || isPaymentPending}
            >
              <Text
                style={[
          ...
          <TouchableOpacity
            style={[styles.button, (processing || isPaymentPending) && styles.buttonDisabled]}
